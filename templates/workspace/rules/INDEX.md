...
| 文件 | 职责 | 何时读取 |
|------|------|----------|
| `README.md` | 多项目工作区人工入口 | 不熟悉目录结构时 |
| `STRUCTURE.md` | 全局结构地图和维护清单 | 检查或调整工作区结构时 |
| `CLAUDE.md` / `AGENTS.md` | Agent 入口、操作路由、阶段边界 | 每次在 `__WORKSPACE_ROOT__` 开启 session |
...
| `vibe-coding-新项目初始化指南.md` | 新项目接入 多项目工作区的流程 | 引入新项目 |
...
| 新增复杂需求方案 | `briefs/INDEX.md`、对应 `briefs/<类型>/<需求名>/` |
